...
Loader that uses DocTR OCR models to extract text from images
...
import numpy as np
from src.backend.utils import get_device, clear_torch_cache
from doctr.utils.common_types import AbstractFile


class CustomOCRLoader(ImageCaptionLoader):
    ...
    def load_model(self):
        try:
            ...
            raise ValueError(
                "`doctr` package not found, please install it."
            )
        if self._ocr_model:
