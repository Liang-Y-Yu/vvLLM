...
from src.backend.prompter import Prompter, PromptType
...
class CustomTextGenerationPipeline(TextGenerationPipeline):
    ...
    def limit_prompt(prompt_text, tokenizer, max_prompt_length=None):
        ...
        if hasattr(tokenizer, 'model_max_length'):
            # model_max_length only defined for generate.py
    ...
    def preprocess(self, prompt_text, prefix="", handle_long_generation=None, **generate_kwargs):
        prompt_text, num_prompt_tokens = CustomTextGenerationPipeline.limit_prompt(prompt_text, self.tokenizer)
